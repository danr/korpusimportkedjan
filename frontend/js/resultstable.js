...
(function() {
  ...
  window.make_table = function(data, attributes) {
    var SLICE_SIZE, col, columns, corpus, correct, display, display_suspended, loading, make_deptrees, new_window, s, sentences, show_next, tables, xml_sentences;
    window.data = data;
    col = function(s) {
      return {
        name: s,
    ...
    show_next = function(m_suspended, fuel) {
      var link, load_more, m, new_suspended, show_more;
      m = m_suspended();
      if (m.result != null) {
        return console.log("RESULT:", m.result);
      } else if (m.cont != null) {
