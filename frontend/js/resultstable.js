...
(function() {
  var append_array_to_table, delay_viewport_change, display, lemgram_link, saldo_link, split_pipes, tabulate_sentence, to_array, xml_attr_value;
    ...
    return rec = function(tag, div) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push((function() {
          var attr, closed, contents, el, footer, header, _j, _k, _len1, _len2, _ref1, _ref2;
          ...
          for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
            el = _ref2[_k];
            el.click(function() {
              var e, _l, _len3, _ref3;
              closed.show();
              _ref3 = [header, contents, footer];
